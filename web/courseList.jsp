                ...
                <div class="col-lg-3">
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" class="form-control sidebar-search-input" placeholder="Search..." name="search" value="${searchKeyword}" form="filterForm">
                            <button class="btn btn-light sidebar-search-btn" type="submit" form="filterForm"></button>
                        </div>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function validateDisplayOptions() {
                    ...
                    if (!atLeastOneChecked) {
                        // Nếu không có tùy chọn nào được chọn, tự động chọn Thumbnail
                        document.getElementById('showThumbnail').checked = true;
                    }
                    filterForm.submit(); // Gửi form để cập nhật
                }

                // Khởi tạo kiểm tra khi tải trang
