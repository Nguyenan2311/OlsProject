                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12 m-b30">
                                    <div class="profile-content-bx">
                                        ...
                                        <form action="update-user-profile" method="post" class="edit-profile">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        <input class="form-control" type="text" value="${sessionScope.user.first_name}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Last Name</label>
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        <input class="form-control" type="text" value="${sessionScope.user.last_name}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Gender</label>
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        <input class="form-control" type="text" value="${sessionScope.user.gender}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                        ...
                                                        <div class="square-media">
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${o.media_type eq 'video'}">
                                                                    <video src="${o.media_path}" controls></video>
                                                                    </c:when>
                                                                </c:choose>
                                                        </div>
